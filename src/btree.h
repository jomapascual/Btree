 ...
 */
//                                                     level     size              extra pageNo                  key       pageNo
const  int INTARRAYNONLEAFSIZE = ( Page::SIZE - sizeof( int ) - sizeof( int ) - sizeof( PageId ) ) / ( sizeof( int ) + sizeof( PageId ) );
...
class BTreeIndex {
 ...
 private:
  ...
  /**
   * A boolean value to check if the root is leaf.
   */
  bool rootIsLeaf;
